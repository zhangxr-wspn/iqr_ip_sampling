...
"""
Plot the trade-off curve for self-BLEU 5 against PPL.
"""
...
output_fig = Path(output_dir) / f'fig_q_d_bleu5_gpt2_xl.svg'
...
def main():
    ...
    ax.add_artist(Ellipse((3.2, 0.24), 0.2, 0.1, facecolor='none', edgecolor='red'))
    plt.annotate('All methods are on par', xy=(3.35, 0.26),
                 xycoords='data', size=6, color='red', )

    plt.annotate('Gold', xy=(np.log(18.34) + 0.15, 0.17 - 0.01),
